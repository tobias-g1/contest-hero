...
router.post('/create_contest', validate(create_contest), checkSteemConnect, checkUser, contest_controller.create_contest);
...
router.put('/set_winners', validate(set_winners), checkSteemConnect, checkUser, contest_controller.set_winners);
